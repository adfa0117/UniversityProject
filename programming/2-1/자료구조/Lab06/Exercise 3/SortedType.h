...
public:
  ...
  void MergeList(SortedType& other, SortedType& result);
...
template <class ItemType>
void SortedType<ItemType>::MergeList(SortedType& other, SortedType& result)
{
    NodeType<ItemType>* ptr = listData;
    NodeType<ItemType>* otherPtr = other.listData;
    result.MakeEmpty();
    NodeType<ItemType>* resultPtr = other.listData;

    if (ptr->info < otherPtr->info)
    {
        resultPtr = ptr;
        ptr = ptr->next;
    }
