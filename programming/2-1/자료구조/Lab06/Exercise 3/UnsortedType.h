...
public:
  ...
  void MergeList(UnsortedType& other, UnsortedType& result);
...
template <class ItemType>
void UnsortedType<ItemType>::MergeList(UnsortedType& other, UnsortedType& result)
{
    result.MakeEmpty();
