...
/*
return 0가 함수의 가장 앞부분에 있어서 모든 상황에서 0을 리턴하는 오류가 있다
*/
template <class ItemType>
...
/*
item의 제곱을 더한 것이 아니라 item을 더하는 오류가 있다
*/
template <class ItemType>
...
/*
SumSquares는 제곱수를 더한 값을 반환하는데 그 값을 한번 더 제곱해서 값을 이상하게 만들고, list->info를 사용하지도 않아서 제대로 된 값이 나오지 않고, 덧셈도 존재하지 않는다.
즉 else문에 대한 return값은 아예 잘못되어있다.
*/
template <class ItemType>
